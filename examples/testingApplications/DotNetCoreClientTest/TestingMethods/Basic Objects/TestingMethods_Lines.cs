    ...
    public static partial class TestingMethods
    {
        public static bool Test_Basic\u2040Objects_Lines_Nurbs_Create()
        {
            ...
            try
            {
                ...
                line line1 = new line
                {
                    ...
                    nurbs_knots = new double[] { 0.0, 0.0, 0.0, 0.111, 0.222, 0.333, 0.444, 0.555, 0.666, 0.777, 0.888, 1.0, 1.0, 1.0 }
                };
                ...
                line line2 = new line
                {
                    ...
                    nurbs_order = 4,
                    nurbs_orderSpecified = true,
                    nurbs_knots = new double[] { 0.0, 0.0, 0.0, 0.0, 0.111, 0.222, 0.333, 0.444, 0.555, 0.666, 0.777, 0.888, 1.0, 1.0, 1.0, 1.0 }
                };
                ...
                line line3 = new line
                {
                    ...
                    nurbs_order = 2,
                    nurbs_orderSpecified = true,
                    nurbs_knots = new double[] { 0.0, 0.0, 0.111, 0.222, 0.333, 0.444, 0.555, 0.666, 0.777, 0.888, 1.0, 1.0 }
                };
        ...
        public static bool Test_Basic\u2040Objects_Lines_Nurbs_Modify()
        {
            ...
            try
            {
                ...
                line.nurbs_control_points = new line_nurbs_control_points[]
                {
                    new line_nurbs_control_points().SetNurbsLocalControlPoint(3.000, -1.000, 0.000, 1.000),
                    new line_nurbs_control_points().SetNurbsLocalControlPoint(1.205, -2.793, 0.000, 1.100),
                    new line_nurbs_control_points().SetNurbsLocalControlPoint(1.000, -4.000, 0.000, 1.200),
                ...
                line.nurbs_order = 4;
                line.nurbs_knots = new double[] { 0.0, 0.0, 0.0, 0.0, 0.111, 0.222, 0.333, 0.444, 0.555, 0.666, 0.777, 0.888, 1.0, 1.0, 1.0, 1.0 };
                SoapModelClient.set_line(line);
                ...
                line.nurbs_order = 2;
                line.nurbs_knots = new double[] { 0.0, 0.0, 0.111, 0.222, 0.333, 0.444, 0.555, 0.666, 0.777, 0.888, 1.0, 1.0 };
                SoapModelClient.set_line(line);
