            ...
            try
            {
                ...
                */
                ...
                if (!string.IsNullOrEmpty(fileName))
                {
                    ...
                    DataLogger.AddText($"Model path: {fileName}");

                    string endpoint = SoapApplicationClient.open_model(fileName);
            ...
            try
            {
                ...
                */
                ...
                if (!string.IsNullOrEmpty(fileName))
                {
                    ...
                    SoapModelClient.run_script(fileName);
