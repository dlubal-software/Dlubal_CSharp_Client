    ...
    public partial class TestingMethods
    {
        ...
        public static bool Test_Load\u2040Cases\u2040and\u2040Combinations_Action\u2040Combinations_Create()
        {
            ...
            try
            {
                ...
                SoapModelClient.run_script(Path.Combine(ScriptDirectoryPath, @"internal\tests\actionCombinationsPrepare.js"));
            ...
            try
            {
                ...
                {
                    no = 1,
                    design_situation_type = 6122, // ULS (EQU) - Permanent and transient
                    design_situation_typeSpecified = true
                };
                ...
                combinationWizard = new combination_wizard()
                {
                    ...
                    //additionally_envelope = true,
                    //additionally_envelopeSpecified = true
                };
                ...
                action.items[0].acting_group_number = 1;
                action.items[0].acting_group_numberSpecified = true;
                action.items[1].acting_group_number = 2;
                action.items[1].acting_group_numberSpecified = true;
                SoapModelClient.set_action(action);
                ...
                action_combination actionCombination = new action_combination()
                {
                    ...
                    items = new action_combination_items[]
                    {
                        new action_combination_items()
                        {
                            action_item = 7,
