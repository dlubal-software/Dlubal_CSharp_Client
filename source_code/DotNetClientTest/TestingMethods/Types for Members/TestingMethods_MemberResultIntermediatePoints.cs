...
namespace Dlubal.WS.Clients.DotNetClientTest
{
    ...
    {
        private static member_result_intermediate_point_distances_row[] From_Distances(in member_result_intermediate_point_distances[] distances)
        {
        ...
        public static bool Test_Types\u2040for\u2040Members_Member\u2040Result\u2040Intermediate\u2040Points_Create()
        {
            ...
            try
            {
                ...
                member_result_intermediate_point point = new member_result_intermediate_point
                {
                    ...
                    distances = From_Distances
                    (
                        new member_result_intermediate_point_distances[]
                        {
