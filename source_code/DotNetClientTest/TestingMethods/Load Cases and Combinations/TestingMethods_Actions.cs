    ...
    public partial class TestingMethods
    {
        ...
        public static bool Test_Load\u2040Cases\u2040and\u2040Combinations_Actions_Create()
        {
            ...
            try
            {
                ...
                SoapModelClient.run_script(Path.Combine(ScriptDirectoryPaths[0], @"internal\tests\actionsPrepare.js"));
            ...
            try
            {
                ...
                {
                    no = 15,
                    action_category = "ACTION_CATEGORY_TEMPERATURE_NON_FIRE_QT"
                };
                ...
                {
                    no = 14,
                    action_category = "ACTION_CATEGORY_IMPOSED_LOADS_CATEGORY_C_CONGREGATION_AREAS_QI_C",
                    action_type = action_action_type.ACTING_SIMULTANEOUSLY,
                    action_typeSpecified = true,
